...
This repository is a collection of tools, cheatsheets, guides, and reference material for penetration testing and red team engagements.

---

## General / Productivity / Cheat Sheets
...
- [SecLists](https://github.com/danielmiessler/SecLists) - Essential wordlists repository with usernames, passwords, URLs, fuzzing payloads, and more
...
Everything in this repository is intended strictly for **authorized** security testing such as CTFs, bug bounty programs with defined scope, and engagements covered by a signed rules of engagement (RoE) or penetration testing agreement. Do not use these resources against systems you do not own or have explicit written permission to test.
